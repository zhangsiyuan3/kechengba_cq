...
let page = 1, size = 20;
let quan_id = '',quan_name,quan_money;
...
Page({
  ...
  onShareAppMessage: function () {
   ...
   cantuan: function (e) {
     ...
     candian="false";
     wx.navigateTo({
       url: '../YouOuder/YouOuder?kid=' + kid + '&title=' + that.data.model.Title + "&img=" + that.data.model.PicturePath + "&op=" + that.data.oprice + "&jp=" + that.data.jianprice + `&quan_id=${quan_id}&quan_name=${quan_name}&quan_money=${quan_money}`
     });
     }
   },
   detial:function(){
