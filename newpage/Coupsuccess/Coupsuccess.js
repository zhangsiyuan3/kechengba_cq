...
Page({
  ...
  kecheng: function () {
    var that=this;
    //'id=9&yu=0&copenid=0&quan_id=&quan_name=&quan_money=0'
    wx.redirectTo({
      url: `/Kecheng/YouHui/YouHui?id=${that.data.kid}&yu=0&copenid=0`,
    })
    // wx.redirectTo({
    //   url: '../Coupcour/Coupcour?yu=0&csid=0&price=0&copenid=0&id=' + that.data.kid
    // })
  },
  /**
   * 生命周期函数--监听页面初次渲染完成
