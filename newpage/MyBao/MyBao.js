...
Page({
  data: {
    daichai: common.config.StaticPath + "cia_07.png",
    yichai: common.config.StaticPath + "overred_03.png",
    shibai: common.config.StaticPath + "huihong_03.png",
    xiantiao: common.config.StaticPath + "boliang_07.png",
    jiao: common.config.StaticPath + "jiantou-red_06.png",
    shixiao: common.config.StaticPath + "shixiao_14.png",
    redPockets: [],
    redTotal: '0.00',
    pageIndex: 1,
    pageSize: 10
            ...
            mm =
              {
                ...
                esid: list[i].Id,
                types: list[i].Type,
              baoimg: common.config.StaticPath + "cia_07.png",
                rem: name + "发起的红包",
            ...
            mm =
              {
                ...
                esid: list[i].Id,
                types: list[i].Type,
              baoimg: common.config.StaticPath + "overred_03.png",
                rem: name + "发起的红包",
                jiren: "恭喜您，红包已瓜分",
                myprice: list[i].MyPrice,
                copenid: list[i].ColonelOpenId,
            ...
            mm =
              {
                ...
                esid: list[i].Id,
                types: list[i].Type,
              baoimg: common.config.StaticPath + "huihong_03.png",
                rem: name + "发起的红包",
