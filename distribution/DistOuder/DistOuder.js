...
Page({
              ...
              success: function (res) {
                ...
                wx.requestPayment({
                  ...
                  success: function (res) {
                    ...
                    // 支付成功
                    wx.redirectTo({
                      url: "../Distsuccess/Distsuccess?gid=0&zhi=1"
                    })
                  },
                  fail: function (res) {
  ...
  kecheng:function(e){
    var that=this;
    wx.navigateTo({
      url: '../Detail/Detail?id=' + that.data.kid + '&openid=' + that.data.dopenid,
    });
  },
  getUserInfo(e) {
    console.log(e)
